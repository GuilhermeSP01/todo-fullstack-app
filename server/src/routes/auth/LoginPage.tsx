                ...
                onSubmit={(values, actions) => { 
                    ...
                    <Form className="w-1/2">
                            ...
                            <div className="mb-8 flex justify-center gap-8">
                                ...
                                <Button variant="secondary" className="text-white w-2/5"> Cadastrar-se </Button>
                            </div>
                            ...
                            <div className="mb-4 flex flex-col gap-4 items-center">
                                ...
                                <div className="flex justify-center gap-8">
                                    <Button variant="outline" className="w-4/5 gap-1 text-white text-base">
                                        <FaGoogle className="mr-2" size={18} /> Google
                                    </Button>
                                    <Button variant="outline" className="w-4/5 text-white text-base">
